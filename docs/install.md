...
docker run -d --name controltower \
  ...
  ghcr.io/joshmaster2165/controltower:0.1.2
```

- **Tags:** `latest` is the newest release, `0.1.2` pins one, `main` follows the main branch.
...
1. In [Railway](https://railway.com/new), create a project and choose **Docker Image** as the source: `ghcr.io/joshmaster2165/controltower:latest` (or pin `:0.1.2`).
